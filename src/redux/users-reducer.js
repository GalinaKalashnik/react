        ...
        case TOGGLE_IS_FOLLOWING_PROGRESS: {
            return {
                ...
                followingInProgress: action.isFetching
                    //что бы кнопка дизейблилась только у того юзера по которому нажали
...
export const requestUsers = (page, pageSize) => {
    return async (dispatch) => {
        ...
        //this.props.page и this.props.pageSize берутся из стейта записанные в него в mapStateToProps src/components/Users/UsersContainer.jsx
